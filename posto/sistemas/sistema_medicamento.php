...
<a href="sistema.php" style="text-decoration:none" name="submit" id="submit"class="inputUser">Voltar</a>
  ...
  <a href="medicamento_cadastro.php"><img src="imagens_sistema/cadastro_medicamento.png" alt="Imagem 1" ></a>
    <h3>Cadastro de Medicamentos</h3>
  </div>
  <div class="image-wrapper">
  <a href="medicamento_estoque.php"><img src="imagens_sistema/medicamento_estoque.png" alt="Imagem 2"></a>
