...
// SISTEMA onde está salvo os dados cadastrais dos pacientes
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM vacina_cadastro WHERE id LIKE '%$data%' or nome_vacina LIKE '%$data%' or ORDER BY id DESC";
    }
    else
    {
...
<script>
    ...
    function searchData()
    {
        window.location = 'vacina_cadastro.php?search='+search.value;
    }
</script>
</html>