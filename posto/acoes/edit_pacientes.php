...
<body>
    <a href="sistema_paciente.php">Voltar</a>
    <div class="box">
        <form action="saveEdit.php" method="POST">
            <fieldset>
                ...
                <br>
                <div class="inputBox">
                    <input type="text" name="nome" id="nome" class="inputUser"  value="dt_recebimento<?php echo $dt_recebimento?>">
                ...
                <br><br>
                <div class="inputBox">
                    <input type="tel" name="telefone" id="telefone" class="inputUser" oninput=mascara_telefone() maxlegth="14" value="<?php echo $telefone?>" required>
                ...
                <br>
                <input type="radio" id="nao-binario" name="sexo" value="nao-binario" <?php echo $sexo == 'nao-binario' ? 'checked' : '' ?> required>
                <label for="nao-Binario">Não-Binário</label>
            
                <br><br>
                <label for="data_nascimento"><b>Data de Nascimento: </b></label>
                <input type="date" name="data_nascimento" id="data_nascimento" class="date"  value=<?php echo $data_nasc;?>required>
                <br><br><br>
                <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <p>Alergia:</p>
                <br>
                <input type="radio" id="respiratória" name="alergia" value="respiratória"<?php echo $alergia == 'respiratória' ? 'checked' : '' ?> required>
                <label for="respiratória">Respiratória</label>
                <br>
                <input type="radio" id="demartologica" name="alergia" value="demartologica" <?php echo $alergia == 'demartologica' ? 'checked' : '' ?> required>
                <label for="demartologica">Demartológica</label>
                <br>
                <input type="radio" id="medicamentosa" name="alergia" value="medicamentosa" <?php echo $alergia == 'medicamentosa' ? 'checked' : '' ?> required>
                <label for="medicamentosa">Medicamentosa</label>
                <br>
                <input type="radio" id="ocular" name="alergia" value="ocular" <?php echo $alergia == 'ocular' ? 'checked' : '' ?> required>
                <label for="ocular">Ocular</label>
                <br>
                <input type="radio" id="alimentar" name="alergia" value="alimentar"<?php echo $alergia == 'alimentar' ? 'checked' : '' ?> required>
                <label for="alimentar">Alimentar</label>
                <br>
                <input type="radio" id="nao" name="alergia"  value="outro" <?php echo ($sexo == 'outro') ? 'checked' : '';?>required>
                <label for="nao">Não</label>
                <br><br>
                <div class="inputBox">
                    <input type="text" name="descricao_alergia" id="descricao_alergia" class="inputUser" value="<?php echo $descricao_alergia?>" required>
