    ...
    <div class="box">
        <form action="saveEdit.php" method="POST">
            <fieldset>
                ...
                <input type="date" name="data_nascimento" id="data_nascimento" class="date"  value="data_nascimento<?php echo $data_nasc?>" required>
                <br><br><br>
                <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <br>
                <input type="radio" id="nao" name="alergia" value="nao" <?php echo $alergia == 'nao' ? 'checked' : '' ?>required>
