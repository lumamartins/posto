    ...
    if(!empty($_GET['id']))
    {
        ...
        if($result->num_rows > 0)
        {
            while($user_data = mysqli_fetch_assoc($result))
            {
                ...
                $dt_fabricacao = $user_data['dt_fabricacao'];
                $dt_validade = $user_data['dt_validade'];
        } 
    }
        else
        {
    ...
    <div class="box">
        <form action="saveEditt.php" method="POST">
            ...
            <br>
                ...
                <input type="date" name="dt_recebimento" id="dt_recebimento" class="date"  value="<?php echo $dt_recebimento?>" required>
                <br><br><br>
                <br><br>
            
            <label for="dt_fabricacao"><b>Data de Fabricação: </b></label>
            <input type="date" name="dt_fabricacao" id="dt_fabricacao" class="date"  value="<?php echo $dt_fabricacao?>" required>
            <br><br><br>
            <br><br>
            
            <label for="dt_validade"><b>Data de Validade: </b></label>
            <input type="date" name="dt_validade" id="dt_validade" class="date"  value="<?php echo $dt_validade?>" required>
            <br><br><br>
                <div class="inputBox">
