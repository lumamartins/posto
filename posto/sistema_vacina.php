...
<body>
  ...
  <div class="image-wrapper">
  <a href="vac_cad_paciente.php"><img src="imagens_sistema/vacina_estoque.png" alt="Imagem 2"></a>
    <h3>Registro da Vacinação - Pacientes</h3>
  </div>
  <div class="image-wrapper">
  <a href="historico_vac_paciente.php"><img src="imagens_sistema/vacina_estoque.png" alt="Imagem 2"></a>
