...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO medicamento_cadastro(nome, nome_comercial, dosagem, fabricante, origem, forma_farmaceutica, tipo_uso, numero_registro, validade) 
    VALUES('$nome', '$nome_comercial','$dosagem','$fabricante','$origem','$forma_farmaceutica','$tipo_uso','$numero_registro','$validade') ");
}
...
<br><br>
                ...
                <div class="inputBox">
                    <input type="text" name="numero_registro" id="nome" class="inputUser" placeholder="XXXXXXXXXXXXX" required><br>
