...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO medicamento_paciente(nome_medicamento, nome_paciente, cpf) 
    VALUES( '$nome_medicamento','$nome','$cpf') ");
}
...
<div class="container">
        ...
        <div class="form">
            <form action="medicamento_prescrito.php" method="POST">
                <div class="form-header">
                    <div class="title">
                        <h1>Registro de Medicamentos Prescritos</h1>
                    </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-group">
                    <div class="input-box">
                    <label for="nome_vacina" class="labelInput">Medicamento</label>
                    <input type="text" name="nome_medicamento" id="nome_medicamento" class="inputUser" required>
                    </div>
