...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO vacina_cadastro(nome_vacina,fabricante,quantidade,lote,origem,dt_recebimento,dt_fabricacao,dt_validade) 
    VALUES('$nome_vacina', '$fabricante','$quantidade','$lote','$origem','$dt_recebimento','$dt_fabricacao','$dt_validade') ");
}
...
<div class="container">
        ...
        <div class="form">
            <form action="vacina_cadastro.php" method="POST">
                ...
                <input type="date" name="dt_recebimento" id="dt_recebimento" class="date" required>
                    </div>
                    <div class="input-box">
