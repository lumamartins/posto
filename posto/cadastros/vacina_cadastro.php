...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO vacina_cadastro(nome_vacina,fabricante,quantidade,lote,origem,dt_recebimento) 
    VALUES('$nome_vacina', '$fabricante','$quantidade','$lote','$origem','$dt_recebimento') ");
}
