...
?>
    ...
    <style>
        body {
            background-image: url(imagens_home/back_sistema.jpg);
...
<body>
    ...
    <main>
        ...
        <div class="Func_pac_login">
           <a href="cadastro_funcionario.php"> <img src="imagens_home/cad_func.png" alt="CadastroFunc "></a>
        </div>
        <div class="Func_pac_login">
           <a href="cadastro_paciente.php"> <img src="imagens_home/cad_pac.png" alt="CadastroPac"></a>
        </div>
        <div class="Func_pac_login">
            <a href="login.php"><img src="imagens_home/icon_login.png" alt="Login"></a>
        </div>
