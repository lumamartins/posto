...
// SISTEMA onde está salvo os dados cadastrais dos pacientes
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM pacientes WHERE id LIKE '%$data%' or nome LIKE '%$data%' or ORDER BY id DESC";
    }
    else
    {
        ...
        <table class="table text-white table-bg">
            <thead>
                <tr>
                    ...
                    <th scope="col">Descrição da alergia:</th>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='edit_pacientes.php?id=$user_data[id]' title='Editar'>
